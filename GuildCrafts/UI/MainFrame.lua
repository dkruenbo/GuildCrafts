...
function UI:CreateSearchBar(parent)
    ...
    search:SetPoint("RIGHT", container, "RIGHT", -178, 0)
    ...
    local origBtn = makeExpBtn("Orig", -128, 46)
    ...
    tbcBtn:SetScript("OnEnter",  function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMLEFT")
    ...
    origBtn:SetScript("OnEnter", function(self)
        GameTooltip:SetOwner(self, "ANCHOR_BOTTOMLEFT")
        GameTooltip:AddLine("Classic Recipes", 1, 1, 1)
        GameTooltip:AddLine("Show Original Classic recipes.", 0.7, 0.7, 0.7)
        GameTooltip:Show()
    end)
