...
def main():
    ...
    print("Step 5: subtracting keys already in Data_TBC.lua, Data_WOTLK.lua, and Data_CATA.lua...")
    tbc_keys = load_known_keys_from_lua(DATA_TBC_SRC)
    wotlk_keys = load_known_keys_from_lua(DATA_WOTLK_SRC)
    cata_keys = load_known_keys_from_lua(DATA_CATA_SRC)
    existing_keys = tbc_keys | wotlk_keys | cata_keys
